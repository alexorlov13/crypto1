...
main_menu_inline.row(InlineKeyboardButton('ℹ️ ЧаВо?', callback_data='faq'),
                    InlineKeyboardButton('👁‍🗨 Суппорт', url=SUPPORT_LINK))
main_menu_inline.row(InlineKeyboardButton('👥‍ COMMUNITY', url="https://t.me/mutant_cash"))
...
exchange_valute.row(InlineKeyboardButton('Купить CRYPTO', callback_data='fiat_to_crypto'))
exchange_valute.row(InlineKeyboardButton('Продать CRYPTO', callback_data='crypto_to_fiat'))
...
supprot_key.row(InlineKeyboardButton('👁‍🗨 Суппорт', url=SUPPORT_LINK))
